...
var network_list = require("./network_list.js").networks;
var networks = [];
var networkMaps = {};
...
for(var index in network_list) {
    var data = network_list[index];
    data.xpubkey = 0x0488b21e;
    data.xprivkey = 0x0488ade4;
    addNetwork(data);
}
