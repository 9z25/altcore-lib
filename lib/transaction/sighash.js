 ...
 */
var sighash = function sighash(transaction, sighashType, inputNumber, subscript, network) {
  ...
  var buf = new BufferWriter()
    ...
    .toBuffer();
  if(!network || network.transactionHashAlgo == 'double-sha256') {
      var ret = Hash.sha256sha256(buf);
  } else if(network.transactionHashAlgo == 'single-sha256') {
