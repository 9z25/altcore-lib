...
Transaction.prototype._getHash = function() {
  if(!this.network.transactionHashAlgo || this.network.transactionHashAlgo == 'double-sha256') {
    return Hash.sha256sha256(this.toBuffer());
  } else if(this.network.transactionHashAlgo == 'single-sha256') {
    console.log("using single sha256 algo");
    return Hash.sha256(this.toBuffer());
  } else {
    throw new Error("Hash Algorithm not implemented yet");
  }
};
